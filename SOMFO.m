...
function SOMFO(fun,foutput,nloop,nsol,nvar,nbit,a,b)
...
while Iteration<Max_iteration+1
    ...
    for i=1:size(Moth_pos,1)
        ...
        [Moth_fitness(1,i),f(i),g(:,i)]=feval(fobj,Moth_pos(i,:)');  
...
[fpmin,nmin]=min(fp);
xmin=x(nmin,:)';fmin=f(:,nmin);gmin=g(:,nmin);
maxeval=nloop*nsol;
